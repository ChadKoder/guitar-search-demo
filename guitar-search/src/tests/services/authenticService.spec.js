describe("guitarService", function () {
    ...
    beforeEach(function () {
        ...
        inject(function (_guitarService_, $httpBackend) {
            guitarService = _guitarService_;
            httpBackend = $httpBackend;

            guitarService.setApiKey = jasmine.createSpy();
            guitarService.reader.send = jasmine.createSpy();

            guitarService.reader.onreadystatechange = jasmine.createSpy().and.callFake(function() {
                guitarService.apiKey = 'api_key';
            });
        });
    });

    it('should set self.apiKey to null', function() {
        expect(guitarService.apiKey).toBe(null);
    });
    ...
    describe("getSearchResults", function () {
        it("should return results", function () {
            ...
            spyOn(guitarService, 'retrieveApiKey').and.callThrough();
            spyOn(guitarService, 'buildAuthenticguitarsUrl').and.callThrough();
            spyOn(guitarService, 'buildSearchParameter').and.callThrough();
            
            guitarService.getSearchResults('title').success(function() {
                expect(guitarService.apiKey).toBe('api_key');
                expect(guitarService.retrieveApiKey).toHaveBeenCalled();
                expect(guitarService.buildAuthenticguitarsUrl).toHaveBeenCalled();
                expect(guitarService.buildSearchParameter).toHaveBeenCalled();
            });
