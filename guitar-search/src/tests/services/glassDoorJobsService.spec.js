describe("glassDoorJobsService", function () {
    var glassDoorJobsService,
        httpBackend,
        url = 'http://api.glassdoor.com/api/api.htm?v=1&format=json&t.p=id&t.k=key&action=guitars-prog&guitarTitle=title&userip=1.2.3.4&usergent=chrome&callback=JSON_CALLBACK';
    ...
    describe("getSearchResults", function () {
        it("should return results", function () {
            ...
            spyOn(glassDoorJobsService, 'buildglassDoorguitarsUrl').and.callThrough();
            ...
            glassDoorJobsService.getSearchResults('title').success(function () {
                ...
                expect(glassDoorJobsService.buildglassDoorguitarsUrl).toHaveBeenCalled();
