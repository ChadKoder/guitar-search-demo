...
angular.module('searchService', []).factory('searchService', ['$http', '$resource', function ($http, $resource) {
    ...
    return {
        getSearchResults: function (searchText) {
            ...
            //php,mysql SEARCH TEXT FROM EXAMPLE
            ...
            var tempUrl = baseUrl + searchMethod + '&telecommuting=1&format=json'
                + searchParameter + '&perpage=5&callback=JSON_CALLBACK';
            return $http.jsonp(tempUrl);
